  ...
  return (
    <nav
      className={cn(
        ...
        isScrolled ? 'bg-luxury-black/80 backdrop-blur-lg border-b border-white/10 py-3' : 'bg-transparent'
      )}
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          <div className="w-10 h-10 bg-gold-500 rounded-full flex items-center justify-center gold-glow">
            <span className="text-luxury-black font-serif font-bold text-xl">K</span>
          </div>
            ...
            <div className="flex flex-col p-6 gap-4">
              {navLinks.map((link) => (
                <a
                  ...
                  className="text-lg font-serif text-white/80 hover:text-gold-400 transition-colors"
                >
                  {link.name}
                </a>
              ))}
